...
public class MainActivity extends AppCompatActivity {
    ...
    TextView show;
    String url;
    String apikey= "41cb3ea403c454d2bdb1cbc97cb14562";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              try{
                if(city!=null) {
                   String url = "https://api.openweathermap.org/data/2.5/weather?lat=44.34&lon=10.99&appid=41cb3ea403c454d2bdb1cbc97cb14562";
                } else {
                  Toast.makeText(MainActivity.this,"Enter City" , Toast.LENGTH_SHORT).show();
                }
                  getWeather tasks = null; new getWeather();
                  temp[0]  = tasks.execute(url).get();
